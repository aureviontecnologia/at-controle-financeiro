  ...
  async function save() {
    ...
    try {
      ...
      if (user.demo) {
        ...
        else await createOnlineCard({ ...common, userId: user.id, idempotencyKey: createRequestKey.current });
      }
...
const styles = StyleSheet.create({
  flex: { flex: 1 }, header: { paddingTop: spacing.md, minHeight: 48, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }, close: { width: 44, height: 44, borderRadius: 15, alignItems: 'center', justifyContent: 'center' }, feedback: { borderRadius: radii.md, padding: spacing.md }, summary: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }, add: { width: 46, height: 46, borderRadius: 15, alignItems: 'center', justifyContent: 'center' }, list: { paddingVertical: spacing.xs }, cardRow: { minHeight: 128, flexDirection: 'row', alignItems: 'flex-start', gap: spacing.md, paddingVertical: spacing.md }, rowPressed: { opacity: 0.62 }, icon: { width: 42, height: 42, borderRadius: 14, alignItems: 'center', justifyContent: 'center' }, cardCopy: { flex: 1, minWidth: 0, gap: spacing.xs }, cardName: { flexShrink: 1 }, cardActions: { gap: spacing.sm }, actionIcon: { width: 40, height: 40, borderRadius: 13, alignItems: 'center', justifyContent: 'center' }, disabled: { opacity: 0.35 }, line: { flexDirection: 'row', justifyContent: 'space-between', gap: spacing.sm }, money: { fontSize: 13, flexShrink: 0 }, track: { height: 5, borderRadius: radii.pill, overflow: 'hidden', marginTop: spacing.xs }, fill: { height: '100%', borderRadius: radii.pill }, formHeading: { gap: spacing.xs }, field: { gap: spacing.sm }, compact: { flex: 1 }, input: { minHeight: 54, borderRadius: radii.md, paddingHorizontal: spacing.lg, fontFamily: type.regular, fontSize: 16 }, days: { flexDirection: 'row', gap: spacing.md }, futureHeading: { flexDirection: 'row', alignItems: 'center', gap: spacing.md }, futureCopy: { flex: 1, gap: 3 }, smallAdd: { width: 42, height: 42, borderRadius: 14, alignItems: 'center', justifyContent: 'center' }, futureInvoice: { gap: spacing.md }, futureLine: { flexDirection: 'row', alignItems: 'flex-end', gap: spacing.sm }, deleteButton: { width: 48, height: 54, borderRadius: radii.md, alignItems: 'center', justifyContent: 'center' }, availablePreview: { borderRadius: radii.md, padding: spacing.lg, gap: spacing.xs }, actions: { gap: spacing.sm }, cancel: { minHeight: 46, alignItems: 'center', justifyContent: 'center' },
});
